                            ...
                            <details className="border rounded p-3">
                                ...
                                <div className="mt-3 space-y-3">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <select {...register("brancheId", { valueAsNumber: true })} defaultValue="" className="focus:bg-red-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-red-500 focus:ring-1 focus:ring-red-500 focus:outline-none block w-full p-2.5 pr-10">
                                            {clubs.length > 0 ? (
                                                clubs.map((club) => (
                                    ...
                                    <div className="mb-3">
                                        <label className="block mb-2.5 text-sm font-medium text-heading" >Ajouter une image</label>
                                        <Controller
                                            name="imagePath"
                                            control={control}
                                            render={({ field }) => (
                                                <input
                                                    type="file"
                                                    accept="image/*"
                                                    className="cursor-pointer border rounded-lg p-2 w-full"
                                                    onChange={(e) => {
                                        ...
                                        <div className="flex flex-col items-center">
                                            {preview && (<img src={preview} alt="preview" className="mt-2 h-24 w-24 object-cover rounded-full border" />)}
                                        </div>
                                        {errors.imagePath && (
                            ...
                            <details className="border rounded p-3">
                                ...
                                <div className="mt-3 space-y-3">
                                    ...
                                    <Controller
                                        ...
                                        defaultValue={[]}
                                        render={({ field }) => {
                                            const value = field.value || []; // si undefined, transforme en tableau
